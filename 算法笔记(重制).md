...
例题 [DQUERY](https://www.spoj.com/problems/DQUERY/) (模板题) [P1494](https://www.luogu.com.cn/problem/P1494) 蓝桥2022省赛CA-选数异或 P3901
...
一种思路是强行将树做成括号序列，将其分块跑莫队。进入一层 push 一下这个点，退出就 push 一下负的这个点。那么挪动指针新加入正和新删除负都是 add ，否则是 del 。
