...
询问排序依据：设下标 $i$ 在块 $bel_i$ ，那么以 $bel_l$ 为第一关键字， $bel_r$ 为第二关键字，可以达到 $O(n\sqrt n)$  [复杂度证明](https://www.cnblogs.com/WAMonster/p/10118934.html) 。还可以常数优化：奇偶化排序，若 $bel_l$ 是奇数，就将 $r$ 升序排序、否则将其逆序排序。
...
例题 [DQUERY](https://www.spoj.com/problems/DQUERY/) (模板题) [P1494](https://www.luogu.com.cn/problem/P1494)
